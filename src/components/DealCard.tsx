...
const DealCard: React.FC<DealCardProps> = ({ deal, onClick, isSelected }) => {
  ...
  return (
    <Card 
      className={`bg-gray-800/80 border-gray-700/50 hover:border-gray-600/50 cursor-pointer transition-all duration-200 hover:shadow-xl hover:scale-[1.02] group ${
