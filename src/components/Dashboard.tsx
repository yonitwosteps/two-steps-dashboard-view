  ...
  return (
    <div className="flex-1 p-4 sm:p-6 lg:p-8 overflow-auto bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 min-h-screen">
      ...
      <Tabs defaultValue="pipeline" className="space-y-6">
        <TabsList className="bg-gray-900/60 backdrop-blur-xl border border-gray-700/50 p-1.5 w-full sm:w-auto grid grid-cols-2 sm:flex rounded-xl shadow-lg">
          <TabsTrigger 
            value="pipeline" 
            className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-purple-600 data-[state=active]:text-white data-[state=active]:shadow-lg text-gray-400 hover:text-gray-200 text-xs sm:text-sm font-medium px-4 py-2.5 rounded-lg transition-all duration-300"
          >
            Pipeline
          </TabsTrigger>
          <TabsTrigger 
